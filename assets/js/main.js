...
window.goBack = function (e){
    var defaultLocation = 'http://' + window.siteData.domain;
...
$(document).ready(function(){
    $(".project-link").on('click',function(e){
      ...
      e.preventDefault();
        ...
        $("#ajaxBase").load($(this).attr('href') + " #project-mainwrap", function(responseTxt, statusTxt, xhr){
                if(statusTxt == "success") {

                 $(".project-index")
                        .addClass("project")
                        .fadeIn()
                        .removeClass("project-index");
